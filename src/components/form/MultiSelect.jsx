...
const MultiSelect = ({
  ...
  /* ------------------ Focus safety when options change ------------------ */
  useEffect(() => {
              ...
              {selectedOptions.length > 0 ? (
                selectedOptions.map((value) => {
                  ...
                  return (
                    <div
                      key={value}
                      className="group flex items-center rounded-full bg-gray-100 py-1 pl-2.5 pr-2 text-sm text-gray-800"
                    >
                      <span>{text}</span>
                      <button
                        type="button"
