...
export default function EditGroup() {
    ...
    useEffect(() => {
        ...
        const groupData = {
            ...
            city: "Indore",
            image: "https://via.placeholder.com/300", // existing image
        };
    ...
    const handleSubmit = () => {
        ...
        console.log("Updated Group Payload:", Object.fromEntries(payload));
    ...
    return (
        <>
            <PageBreadcrumb pageTitle="Edit Group" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <MultiSelect
                            ...
                            onChange={(values) =>
                                handleMultiSelect("moderators", values)
                            }
                        />
                    </div>
                    ...
                    <div>
                        <MultiSelect
                            ...
                            onChange={(values) =>
                                handleMultiSelect("activityTypes", values)
                            }
                        />
                    </div>
