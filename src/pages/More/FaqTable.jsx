...
const initialFaqs = [
  ...
  {
    id: 2,
    question: "Pro Tip: Beacon Privacy",
    answer:
      "When you turn your beacon on use the privacy toggle to show everyone where you are, just your friends or the people you want to invite to join you.",
    createdAt: "2024-08-21",
  },
  {
    id: 3,
    question: "Pro Tip: Posts",
    answer:
      "Share intel to your community like trail conditions, wildlife sightings and recent news in your area.",
    createdAt: "2024-08-21",
  },
];
            ...
            <tbody className="">
              {paginatedData.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50 border border-gray-200">
                  ...
                  <td className="px-4 py-3 max-w-[400px] text-gray-600 whitespace-normal break-words">
                    {item.answer}
                  </td>
