...
const initialModalData = [
  {
    ...
    actionText: "poorvi test",
    createdAt: "2025-12-02",
  },
  {
    id: 2,
    modelId: 31,
    image: "https://plus.unsplash.com/premium_photo-1764546983177-c2342bef9ebf?w=500&auto=format&fit=crop&q=60",
    actionText: "sample modal",
            ...
            <tbody className="divide-y divide-gray-200 text-sm">
              {paginatedData.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">{item.actionText}</td>
                  <td className="px-4 py-3">{item.createdAt}</td>
                  <td className="px-4 py-5 flex gap-2">
                    <Button
                      size="sm"
                      variant="edit"
                      onClick={() => navigate(`/modals/edit/${item.id}`)}
        ...
        <div className="bg-gray-200 rounded-2xl shadow-xl w-full max-w-md p-6 animate-fadeIn">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-500 mb-6">
              ...
              <span className="font-medium text-gray-700">{deleteRow?.actionText}</span>?
            </p>
