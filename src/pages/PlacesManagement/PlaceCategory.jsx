...
export default function PlaceCategory() {
    const [data, setData] = useState(initialCategoryData);
    ...
    return (
        <>
            <PageBreadcrumb pageTitle="Place Category" />
            ...
            <div className="rounded-2xl border border-gray-100 bg-white p-4">
                ...
                <div className="mb-4 flex flex-col sm:flex-row items-start justify-between gap-3">
                    ...
                    <div className="flex flex-row items-center gap-3">
                        ...
                        <Button
                            variant="primary"
                            onClick={() => navigate("/places/category/add")}
                                ...
                                <tr key={item.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-4 py-3 flex gap-2">
                                        <Button
                                            size="sm"
                                            variant="edit"
                                            onClick={() => navigate(`/places/category/edit/${item.id}`)}
