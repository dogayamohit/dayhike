...
export default function AdminRolesTable() {
  const [data, setData] = useState(initialRoleData);
  ...
  return (
    <>
      <PageBreadcrumb pageTitle="Admin Roles" />
      ...
      <div className="rounded-2xl border border-gray-100 bg-white p-6">
        ...
        <div className="mb-4 flex flex-col sm:flex-row items-start justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              variant="primary"
              onClick={() => navigate("/admin/admin-role/add")}
            ...
            <tbody className="divide-y divide-gray-200 text-sm">
              {paginatedData.map((item, index) => (
                <tr key={item.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 font-medium">{item.roleName}</td>
                  ...
                  <td className="px-4 py-3 flex gap-2">
                    ...
                    <Button
                      ...
                      variant="view"
                      onClick={() =>
                        navigate(`/admin/admin-role/permissions/${item.id}`)
                      }
                    ...
                    <Button
                      ...
                      variant="edit"
                      onClick={() =>
                        navigate(`/admin/admin-role/edit/${item.id}`)
                      }
