...
const initialReportsData = [
    {
        id: 1,
        reportedBy: "daniperry",
        typeName: "State of the Snowpack #3 w/ BTAC",
        email: "dani@dayhike.com",
        mobile: "+1 9708196732",
        reportType: "Activity",
        reason: "Test",
    ...
    },
    {
        ...
        typeName: "testing for developer",
        email: "evanlyle@gmail.com",
        mobile: "+1 89708196732",
        reportType: "Activity",
        reason: "Delete this",
...
export default function ShowActivityReports() {
