...
const initialReportsData = [
  {
    id: 1,
    reportedBy: "recycledhype",
    typeName: "Evan Birenbaum",
    email: "evanlyle@gmail.com",
    mobile: "+1 8547180912",
    reportType: "User",
    reason: "Offensive",
  ...
  },
  {
    id: 2,
    reportedBy: "chris",
    typeName: "Chris Keller",
    email: "jchrisk1@yahoo.com",
    mobile: "+1 2147180984",
    reportType: "User",
    reason: "He made unwanted sexual advances on me",
...
export default function ShowProfileReports() {
  ...
  return (
    <>
      <PageBreadcrumb pageTitle="Profile Reports" />
                ...
                <tr key={item.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 flex gap-2">
                    {/* <Button
                      size="sm"
                      variant="view"
                      startIcon={<AiOutlineEye size={20} />}
                      onClick={() =>
                        navigate(`/profile-reports/view/${item.id}`)
                      }
                    /> */}
                    <Button
                      size="sm"
