...
export default function ShowGroupReports() {
  ...
  return (
    <>
      <PageBreadcrumb pageTitle="Group Reports" />

      <div className="rounded-2xl border border-gray-100 bg-white p-2 shadow-sm w-full mx-auto
        ...
        {/* Table */}
        <div className="overflow-x-auto max-w-[calc(100vw-20px)] rounded-xl border border-gray-200">
